...
# VERY IMPORTANT FOR QUANTUM TRAINING
# =========================================================
...
# clip values to stable rotation range
...
# =========================================================
# CLASS WEIGHTS
# IMPROVES IMBALANCED CLASS LEARNING
# =========================================================
...
def cross_entropy_loss(theta, X, y, model):
    ...
    for x_i, y_i in zip(X, y):
        ...
        weighted_loss = ce_loss * class_weights[y_i]
...
def run_experiment(
    ...
    for fold, (tr_idx, va_idx) in enumerate(cv.split(X_all, y_all)):
        ...
        for epoch in range(cv_epochs):
            ...
            if early_stop.step(epoch_loss, theta):
